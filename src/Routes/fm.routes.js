...
const { denunciate , addFavorites, getAllArticles ,editArticle ,findFmiItem, createAnArticle, getAllFmItems,getAllFavourite }  = fmFunctions
...
//get All Favourite
router.get('/getAllFmFavItems/:id',getAllFavourite);
